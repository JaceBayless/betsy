...
describe Betsy::Review do
  ...
  describe "get_reviews_by_listing" do
    it "gets the reviews for a listing" do
      stub_request(:get, "https://openapi.etsy.com/v3/application/listings/1/reviews")
        .to_return(status: 200, body: REVIEWS)
      reviews = Betsy::Review.get_reviews_by_listing(1)
      review = reviews.first
      expect(reviews).to be_an_instance_of Array
      expect(review).to be_kind_of Betsy::Review
      expect(review.shop_id).to eq 1
